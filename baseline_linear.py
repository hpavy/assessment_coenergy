...
Best configuration: 100 parts × mean+std+max+min, plain LinearRegression.
800 features per sample.
...
if __name__ == "__main__":
    ...
    print("\n--- Baseline 2: Linear Regression (100 parts × mean+std+max+min) ---")
    metrics_val = train_linear(train_ds, val_ds, n_parts=100)
    metrics_test = train_linear(train_ds, test_ds, n_parts=100)
